...
public class Desempenho extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(pontos <4) {
			...
			resposta.setText(" Você fez: " + pontos + " pontos, não fique triste, tente novamente" );
		}
		
		if(pontos >= 4 || pontos <=6) {
			imgResposta.setImageResource(R.drawable.bem);
			resposta.setText("Você fez: " + pontos + " pontos, você foi bem" );
		}
		
		if(pontos >= 7 || pontos <=10) {
			imgResposta.setImageResource(R.drawable.muitobem);
			resposta.setText("Você fez: " + pontos + " pontos, Parabéns!" );
		}
		
		if(pontos > 10) {
			imgResposta.setImageResource(R.drawable.muitobem);
			resposta.setText("Você fez: " + (pontos - pontos) + " pontos, Parabéns!" );
		}
		
		if(pontos == 10) {
			imgResposta.setImageResource(R.drawable.muitobem);
			resposta.setText("Você fez: " + pontos + 
			" pontos, Parabéns, você acertou todas as questões!!!" );
		}
	}
